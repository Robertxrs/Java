...
public class AlugaVeiculo extends javax.swing.JFrame {
    ...
    public AlugaVeiculo(Aluguel aluguel) {
        initComponents();
    ...
    private void initComponents() {
        ...
        LabelLocal11.setText("Alugue o veiculo");
    ...
    private void bttnConfirmarbttnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttnConfirmarbttnBuscarActionPerformed
        ...
        if (rowIndex != -1) {
            Object valorObj = TabelaVeiculo.getValueAt(rowIndex, 6);
            ...
            if (valorObj != null || veiculoIdObj != null) {
                ...
                VeiculoDAO veiculoDAO = new VeiculoDAO();
                Veiculos veiculo = veiculoDAO.obter(veiculoId);

                atualizarCompra(veiculo,valorVeiculo);

                PagamentoTela pt = new PagamentoTela(valorVeiculo, veiculo);
                pt.setVisible(true);
                this.dispose();
            } else {
   ...
   private void atualizarCompra(Veiculos veiculo, Double valor) {
            if (veiculo != null && valor != 0) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "Erro ao atualizar compra: " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlugaVeiculo.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlugaVeiculo().setVisible(true);
            }
        });
    }
