...
public class PagamentoTela extends javax.swing.JFrame {
    ...
    public PagamentoTela(double valorVeiculo, Veiculos veiculo) {
        initComponents();
    ...
    public PagamentoTela(Aluguel aluguel) {
        initComponents();
        this.aluguel = aluguel;
    }

    public PagamentoTela(Clientes cliente) {
        initComponents();
    ...
    private void initComponents() {
        ...
        LabelRetirada1.setText("Retirada");
        ...
        txtDataPagamento.setText("01/01/2000");
        ...
        LabelValor1.setText("Valor mensal:");
