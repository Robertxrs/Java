...
public class TabelaAluguel extends javax.swing.JFrame {

    /**
     * Creates new form TabelaAluguel
     */
    public TabelaAluguel() {
        initComponents();
        AluguelDAO aluguelDAO = new AluguelDAO();
        List<Aluguel> listaAluguel = aluguelDAO.listar(-1, -1, -1, null, null, null);
        preencheTabela(listaAluguel);
    }

    public void preencheTabela(List<Aluguel> alugueis) {
        if (alugueis != null) {
            String[] columns = {"Id", "Cliente id", "Veiculo id", "Data de retirada", "Valor", "Data de devolução"};
            ...
            for (Aluguel aluguel : alugueis) {
                Object[] rowData = {
                    ...
                    String.valueOf(aluguel.getValor()),
                    aluguel.getDataDevolucao().toString(),};
                model.addRow(rowData);
            }
            TabelaAluguel.setModel(model);
        } else {
            System.out.println("A lista de alugueis está nula.");
        }
    }
    ...
    private void initComponents() {
        ...
        jLabelTitle.setText("Encontrar aluguel por id");
        ...
        TabelaAluguel.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Cliente id", "Veiculo id", "Data de retirada", "Valor", "Data de devolução"
            }
        ));
        TabelaAluguel.setToolTipText("");
    ...
    private void jButtonConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmarActionPerformed
        ...
        try {
            ...
            AluguelDAO aluguelDao = new AluguelDAO();
            List<Aluguel> resultados = aluguelDao.obterId(id);
            DefaultTableModel model = (DefaultTableModel) TabelaAluguel.getModel(); 
            model.setRowCount(0);
            for (Aluguel aluguel : resultados) {
                Object[] rowData = {
                    aluguel.getId(),
                    aluguel.getClienteId(),
                    aluguel.getVeiculoId(),
    ...
    private void jButtonCadastrar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrar1ActionPerformed
        CadastrarAluguel ca = new CadastrarAluguel();
        ca.setVisible(true);
    ...
    private void excluirSelecionado() {
        ...
        if (rowIndex != -1) {
            int aluguelId = Integer.parseInt(TabelaAluguel.getValueAt(rowIndex, 0).toString());
            AluguelDAO aluguelDao = new AluguelDAO();
            aluguelDao.excluir(aluguelId);
            List<Aluguel> ListaCompra = aluguelDao.listar(-1, -1, -1, null, null, null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TabelaAluguel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TabelaAluguel().setVisible(true);
            }
        });
    }
