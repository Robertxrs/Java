...
public class ListagemUser extends javax.swing.JFrame {
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        for (Podcast podcast : resultados) {
            Object[] rowData = {podcast.getId(), podcast.getProdutor(), podcast.getNomeEpisodio(),podcast.getNumero_episodio(), podcast.getDuracao(),podcast.getUrl()};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListagemUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
